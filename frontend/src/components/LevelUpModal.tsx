      ...
      {show && (
        ...
        >
          ...
          >
            ...
            >
              <ArrowUpCircle size={48} className="text-cm-mint" aria-hidden="true" />
            </motion.div>
            <h2 id="levelup-title" className="text-3xl font-black text-cm-mint tracking-tight mb-2">LEVEL UP!</h2>
