...
CATEGORY_QUERIES = {
    ...
    "realized_vol": "realized historical volatility RV HV standard deviation parkinson",
    ...
    "correlation": "correlation dispersion implied realized relative value",
    "event_vol": "event volatility earnings announcements FOMC",
    "tail_risk": "tail risk black swan convexity hedging VaR",
    ...
    "seasonality": "seasonality time-based data OpEx monthly patterns VIX expiration",
    "exotic_structures": "exotic structural data gamma squeeze variance swap 0DTE pinning",
    "fundamentals": "fundamental equity data P/E ratio earnings valuation cash flow",
    "commodities": "commodity energy data oil gold copper natural gas",
    "crypto": "cryptographic asset data bitcoin ethereum DeFi crypto volatility",
    "geopolitical": "global political legal data sanctions tariffs regulation elections",
    "alt_data": "alternative big data satellite imagery credit card sentiment NLP",
    "portfolio_mgmt": "portfolio management metrics sharpe sortino drawdown margin",
}
